...
export const projects: Project[] = [
  ...
  },
  {
    ...
    description: "Système de gestion et de visualisation en temps réel de l'occupation des salles de l'IUT de Blagnac, Université Toulouse 2 Jean Jaurès, avec transmission des données via MQTT et déploiement containerisé.",
    ...
    skills: ["1", "2", "4"],
    context: "Projet universitaire (SAE S3.A.01) réalisé à l'IUT de Blagnac, Université Toulouse 2 Jean Jaurès (janvier 2024 - février 2024) pour résoudre les problèmes de gestion des salles et optimiser leur utilisation.",
    objectives: [
  ...
  },
  {
    ...
    image: "/Portfolio/images/placeholder-project.png",
    description: "Projet d'analyse, rétro-conception et amélioration d'une base de données existante pour le système de gestion BeachAffairs, réalisé à l'IUT de Blagnac, Université Toulouse 2 Jean Jaurès.",
    ...
    skills: ["2", "3"],
    context: "Projet universitaire réalisé à l'IUT de Blagnac, Université Toulouse 2 Jean Jaurès (mai 2023 - juin 2023) visant à approfondir les compétences en analyse, conception et optimisation de bases de données.",
    objectives: [
  ...
  },
  {
    ...
    skills: ["1", "2", "4"],
    context: "Projet universitaire (SAE S5.A.01) réalisé à l'IUT de Blagnac, Université Toulouse 2 Jean Jaurès (septembre 2024 - novembre 2024) en collaboration avec l'Université Toulouse Jean Jaurès et l'Université Paul Sabatier pour améliorer leur site existant (slave-narratives.univ-tlse2.fr).",
    objectives: [
  ...
  },
  {
    ...
    skills: ["2", "4"],
    context: "Projet universitaire (SAE S1.03) réalisé à l'IUT de Blagnac, Université Toulouse 2 Jean Jaurès (novembre 2022 - décembre 2022) visant à apprendre la configuration et la gestion d'un environnement Linux pour le développement logiciel.",
    objectives: [
  ...
  },
  {
    ...
    skills: ["1", "2", "3", "4"],
    context: "Projet universitaire (SAE S6) réalisé à l'IUT de Blagnac, Université Toulouse 2 Jean Jaurès visant à mettre en pratique l'ensemble des compétences acquises durant la formation à travers le développement d'une application web complète avec architecture distribuée.",
    objectives: [
